...
document.write("<center><img src= '/images/"+map_id+"_long_directions.png' alt='directions' style='width:900px;height:900px;'></center>");
...
<TR>
    <div class="wrapper1">
        <TD><form action="/addPoints" method="post"><?php echo Form::token(); ?>
    <input type="submit" class="wrapper1">
</form>
    </div>
</TD>
    <div class="wrapper2">
