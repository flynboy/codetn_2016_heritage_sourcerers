...
document.write("<center><img src= '/images/"+map_id+"_short.jpg' alt='Map' style='width:900px;height:900px;'></center>");


        function short() {
            window.location.href='/directionsShort?map_id=' + map_id+'&l='+l+'&m='+m;
...
<TR>
    ...
    <div class="wrapper3">
        <TD><a href="javascript: short();" class="routebtn3">Directions</a>
    </div>
</TD>
